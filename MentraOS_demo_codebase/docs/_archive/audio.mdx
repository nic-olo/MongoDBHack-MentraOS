---
title: Audio
description: Learn how to play audio from URLs, synthesize speech with ElevenLabs, and manage playback in MentraOS apps.
---
...
Here's a complete example that combines voice input with audio responses:
